...
Create a new S3 bucket with a unique name in the desired AWS region.
Save the bucket name to reference in Terraform scripts.
...
Create a table with a unique name and set a primary key.
Configure read and write capacity settings as needed.
Save the table name for reference.
3. Jenkins Setup
...
Attach this role to the Jenkins EC2 instance.
...
Install Terraform: Follow the official documentation for installing Terraform: https://www.terraform.io/downloads.html
Install Jenkins: Refer to the Jenkins installation guide: https://www.jenkins.io/doc/book/installing/
...
Trigger the pipeline in Jenkins and observe Terraform provisioning resources in AWS automatically.

Terraform will handle the provisioning, and AWS will launch the resources as defined in your configuration files.
